...
func WebNewLab(writer http.ResponseWriter, request *http.Request) {
	...
	lab.Typology.Location, err = strconv.ParseBool(request.FormValue("location"))
	lab.Typology.Nomad, err = strconv.ParseBool(request.FormValue("nomad"))
	lab.Governance.Public, err = strconv.ParseBool(request.FormValue("public"))
	lab.Governance.Private, err = strconv.ParseBool(request.FormValue("private"))
	lab.Themes.Environment, err = strconv.ParseBool(request.FormValue("environment"))
	lab.Themes.DigitalCulture, err = strconv.ParseBool(request.FormValue("digital_culture"))
	lab.Themes.Arts, err = strconv.ParseBool(request.FormValue("arts"))
	lab.Themes.Territory, err = strconv.ParseBool(request.FormValue("territory"))
	lab.Themes.CitizenScience, err = strconv.ParseBool(request.FormValue("citizen_science"))
	lab.Themes.Memory, err = strconv.ParseBool(request.FormValue("memory"))
	lab.Themes.Gender, err = strconv.ParseBool(request.FormValue("gender"))
